...
function CardStored(LandCertificate: LandCertificate) {
  ...
  const storeInBlockchain = async () => {
    try {
      ...
      if (window.ethereum) {
        ...
        const contractAddress = "0xa6E176BB166eDBDA1Be5D4521Df71D784e586a27";
        ...
        // Replace this with the actual function and parameters of your smart contract
        const result = await contract.methods
          .storeLandCertificate(
            LandCertificate.owner,
            LandCertificate.location,
            LandCertificate.description,
            LandCertificate.thumbnail,
            LandCertificate.owner_id
          )
          .send({
            from: userAddress,
          });
      ...
      console.error("Error storing data in the blockchain:", error);
    }
  };
  return (
    <div className="card card-compact w-64 bg-base-100 shadow-xl border border-white">
      <figure>
        <img
          src="data:image/jpeg;base64,"
          alt="Shoes"
...
export { CardSkeleton, Card, CardStored };
